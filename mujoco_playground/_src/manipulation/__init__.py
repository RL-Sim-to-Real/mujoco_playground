...
_envs = {
    ...
    "PandaPickCubeCartesianModified": panda_pick_cartesian_modified.PandaPickCubeCartesianModified,
...
_cfgs = {
    ...
    "PandaPickCubeCartesianModified": panda_pick_cartesian_modified.default_config,
