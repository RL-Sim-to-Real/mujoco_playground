...
_envs = {
    ...
    "PandaPickCuboid": panda_pick_cartesian_modified.PandaPickCuboid,
    "PandaPushCuboid": push.PandaPushCuboid,
...
_cfgs = {
    ...
    "PandaPickCuboid": panda_pick_cartesian_modified.default_config,
    "PandaPushCuboid": push.default_config,
