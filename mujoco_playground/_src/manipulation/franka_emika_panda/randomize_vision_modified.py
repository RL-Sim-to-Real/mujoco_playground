...
from mujoco_playground._src.manipulation.franka_emika_panda import pick_cartesian_modified as pick_cartesian
...
def domain_randomize(
  ...
  mj_model = pick_cartesian.PandaPickCuboid().mj_model
